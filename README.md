...
- 真心話標準：必須有具體行為、影響／代價或深層情緒；成人題可直接，但不強迫點名或性化現場玩家。
- 大冒險固定為 350 題不指定玩家、150 題邀請自願者；每位玩家與自願者都可無條件換題。
- 大冒險建置有禁句品質閘門，會拒絕電話／私訊、同步拍手、跳舞模仿、飲酒懲罰及強迫評選等模板。
- 大冒險另有限制單題最多 72 字的可讀性閘門，安全規則統一放在頁面說明，不重複塞入每題。
